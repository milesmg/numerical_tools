...
In /src, you'll find:
- a notebook that plays around with Newton interpolation, a type of polynomial interpolation, and explores some limitations and extensions of the basic technique.
